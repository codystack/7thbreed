...
?>
      ...
      <section class="position-relative bg-dark pt-lg-4 pt-xl-5">
        <div class="jarallax position-absolute top-0 start-0 w-100 h-100" data-jarallax data-speed="0.4">
          <div class="jarallax-img" style="background-image: url(assets/img/landing/saas-4/hero-bg-pattern.png);"></div>
        </div>
        ...
        <div class="container position-relative z-2 pt-3 pt-md-4 pt-lg-5 mt-lg-2 mt-xl-4">
            ...
            <div class="col-11 col-sm-9 col-md-7 col-lg-6 offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
              <div class="parallax" style="max-width: 636px;">
                ...
                <div class="parallax-layer" style="padding-right: 24.2%;" data-depth="0.1">
                  <img src="assets/img/landing/saas-4/use-cases/data-analysis/line-chart-light.png" class="d-dark-mode-none position-relative rounded-4" style="top: 27.5%; max-width: 482px; box-shadow: 0 12px 48px -8px rgba(189, 196, 221, .35);" alt="Total users line chart">
                  <img src="assets/img/landing/saas-4/use-cases/data-analysis/line-chart-dark.png" class="d-none d-dark-mode-block position-relative rounded-4" style="top: 27.5%; max-width: 482px; box-shadow: 0 12px 48px -8px rgba(0, 0, 0, .25);" alt="Total users line chart">
                </div>
                <div class="parallax-layer" style="padding-left: 45.75%;" data-depth="-0.12">
                  <img src="assets/img/landing/saas-4/use-cases/data-analysis/bar-chart-light.png" class="d-dark-mode-none position-relative rounded-4" style="max-width: 345px; box-shadow: 0 0 48px -4px rgba(189, 196, 221, .35);" alt="Traffic bar chart">
                  <img src="assets/img/landing/saas-4/use-cases/data-analysis/bar-chart-dark.png" class="d-none d-dark-mode-block position-relative rounded-4" style="max-width: 345px; box-shadow: 0 12px 48px -8px rgba(0, 0, 0, .35);" alt="Traffic bar chart">
                </div>
                <div class="parallax-layer" style="padding-right: 7.547%; padding-left: 44.97%;" data-depth="0.3">
                  <img src="assets/img/landing/saas-4/use-cases/data-analysis/donut-chart-light.png" class="d-dark-mode-none position-relative rounded-4" style="top: 60.75%; max-width: 302px; box-shadow: 0 0 48px -4px rgba(189, 196, 221, .35);" alt="Traffic donut chart">
                  <img src="assets/img/landing/saas-4/use-cases/data-analysis/donut-chart-dark.png" class="d-none d-dark-mode-block position-relative rounded-4" style="top: 60.75%; max-width: 302px; box-shadow: 0 -12px 48px -8px rgba(0, 0, 0, .35);" alt="Traffic donut chart">
                </div>
              </div>
            </div>
            ...
            <div class="col-11 col-sm-9 col-md-7 col-lg-6 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
              <div class="parallax" style="max-width: 636px;">
                <div class="parallax-layer" data-depth="0.05">
                  <img src="assets/img/landing/saas-4/use-cases/task-automation/circle-1.png" alt="Circle 1">
                </div>
                <div class="parallax-layer" data-depth="0.1">
                  <img src="assets/img/landing/saas-4/use-cases/task-automation/circle-2.png" alt="Circle 2">
                </div>
                <div class="parallax-layer" data-depth="0.15">
                  <img src="assets/img/landing/saas-4/use-cases/task-automation/circle-3.png" alt="Circle 3">
                </div>
                ...
                <div class="parallax-layer" style="padding-right: 73.3%; padding-left: 11.1%;" data-depth="0.25">
                  <div class="position-relative" style="top: 78.8%;">
                    ...
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-dark-mode-none" style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, .35);"></span>
                    <span class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block" style="background-color: #1c2126;"></span>
                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M33.1883 66.9909H39.8702V50.7636L35.4948 43.1234L30.3247 43.6045V64.1273C30.3247 65.7094 31.6062 66.9909 33.1883 66.9909Z" fill="#0085f7"/><path d="M62.7793 66.9909H69.4612C71.0433 66.9909 72.3248 65.7094 72.3248 64.1273V43.6045L67.1621 43.1234L62.7794 50.7636V66.9909H62.7793Z" fill="#00a94b"/><path d="M62.7794 38.3545L58.8545 45.8442L62.7794 50.7636L72.3249 43.6045V39.7863C72.3249 36.2473 68.2848 34.2261 65.4522 36.35L62.7794 38.3545Z" fill="#ffbc00"/><path fill-rule="evenodd" clip-rule="evenodd" d="M39.8704 50.7636L36.1304 42.8632L39.8704 38.3545L51.3249 46.9454L62.7795 38.3545V50.7636L51.3249 59.3545L39.8704 50.7636Z" fill="#ff4131"/><path d="M30.3247 39.7863V43.6045L39.8702 50.7636V38.3545L37.1974 36.35C34.3648 34.2261 30.3247 36.2473 30.3247 39.7863Z" fill="#e51c19"/></svg>
                  </div>
                </div>
                <div class="parallax-layer" style="padding-right: 68.2%; padding-left: 21%;" data-depth="0.4">
                  <div class="position-relative" style="top: 52.9%;">
                    ...
                    <span class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block" style="background-color: #1c2126;"></span>
                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 72 71" xmlns="http://www.w3.org/2000/svg" fill="#0061ff"><path d="M35.8477 27.045L27.8477 32.1402L35.8477 37.2356L27.8477 42.3308L19.8477 37.2356L27.8477 32.1402L19.8477 27.045L27.8477 21.9498L35.8477 27.045Z"/><path d="M27.8237 44.0212L35.8237 38.926L43.8237 44.0212L35.8237 49.1164L27.8237 44.0212Z"/><path d="M35.8477 37.2356L43.8477 32.1402L35.8477 27.045L43.8477 21.9498L51.8477 27.045L43.8477 32.1402L51.8477 37.2356L43.8477 42.3308L35.8477 37.2356Z"/></svg>
                  </div>
                </div>
          ...
          <div class="row align-items-center justify-content-center py-4 py-md-5 my-2 my-sm-3 my-md-0 my-xl-3">
            <div class="col-11 col-sm-9 col-md-7 col-lg-6 offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
              <div class="parallax" style="max-width: 636px;">
                <div class="parallax-layer" data-depth="0.1">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/window-light.png" class="d-dark-mode-none rounded-4" style="box-shadow: 0 10.2px 41px -6.8px rgba(189, 196, 221, .30);" alt="Chat bot UI window">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/window-dark.png" class="d-none d-dark-mode-block rounded-4" style="box-shadow: 0 10.2px 41px -6.8px rgba(0, 0, 0, .20);" alt="Chat bot UI window">
                </div>
                <div class="parallax-layer" data-depth="0.15">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/message1-light.png" class="d-dark-mode-none" alt="Message">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/message1-dark.png" class="d-none d-dark-mode-block" alt="Message">
                </div>
                <div class="parallax-layer" data-depth="0.25">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/message2-light.png" class="d-dark-mode-none" alt="Message">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/message2-dark.png" class="d-none d-dark-mode-block" alt="Message">
                </div>
                <div class="parallax-layer" data-depth="0.35">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/message3-light.png" class="d-dark-mode-none" alt="Message">
                  <img src="assets/img/landing/saas-4/use-cases/chat-bot/message3-dark.png" class="d-none d-dark-mode-block" alt="Message">
                </div>
              </div>
            </div>
            <div class="col-md-5 col-xl-4 offset-xl-1 order-md-1 text-center text-md-start">
      ...
      <section class="bg-dark py-5" data-bs-theme="dark">
        <div class="container pt-2 py-sm-3 py-md-4 py-lg-5 my-xxl-3">
          <div class="row pt-md-2 pt-lg-3 pt-xl-4 pb-lg-2 pb-xl-3">
            <div class="col-md-6">
              <h2 class="h1 pe-xxl-5 me-xl-4 mb-md-0">Our <span class="text-warning">data centers</span> spread all over the world. Get access  to the API from anywhere</h2>
            </div>
            <div class="col-md-6 col-xl-5 offset-xl-1">
              <p class="text-body fs-xl mb-0">Our data centers are a key component of our global infrastructure, providing reliable and scalable computing resources to customers around the world. We offer a highly distributed and resilient platform that can support the most demanding workloads.</p>
            </div>
          </div>
          <div class="pt-5 mt-sm-2 mt-md-3 mt-lg-4 mt-xl-5">
            <img src="assets/img/landing/saas-4/map.png" alt="Map">
          </div>
        </div>
      </section>
      ...
      <section class="position-relative py-5">
        <span class="position-absolute top-0 start-0 w-100 h-100 d-dark-mode-none" style="background: linear-gradient(360deg, #fff 5.39%, #f6f9fc 78.66%);"></span>
        <span class="position-absolute top-0 start-0 w-100 h-100 d-none d-dark-mode-block" style="background: linear-gradient(360deg, #121519 5.39%, rgba(255, 255, 255, .03) 78.66%);"></span>
        <div class="container position-relative z-2 py-2 py-sm-3 py-sm-4 py-md-5">
          <div class="row align-items-center py-lg-2 py-xl-3 my-xl-1 my-xxl-3">
            <div class="col-md-5 col-xl-4">
              <h2 class="h1 pb-2 pb-sm-3 mb-md-0">Learn <span class="text-gradient-primary">how Around works</span> in a nutshell. Watch a short introductory video</h2>
            </div>
            <div class="col-md-7 offset-xl-1">
              <div class="position-relative">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center z-5">
                  <a href="https://www.youtube.com/watch?v=ADpOLD2z1Ns" class="btn btn-icon btn-xl btn-primary rounded-circle stretched-link" data-bs-toggle="video" aria-label="Play video">
                    <i class="ai-play-filled"></i>
                  </a>
                </div>
                <img src="assets/img/landing/saas-4/video-cover-light.jpg" class="d-dark-mode-none rounded-3" alt="Video cover">
                <img src="assets/img/landing/saas-4/video-cover-dark.png" class="d-none d-dark-mode-block rounded-3" alt="Video cover">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="masonry-grid row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4 g-sm-3 g-md-4">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/envato-light.svg" class="d-block d-dark-mode-none mx-auto" width="165" alt="Envato">
                <img src="assets/img/landing/saas-4/integrations/envato-dark.svg" class="d-none d-dark-mode-block mx-auto" width="165" alt="Envato">
                <div class="card-body text-center pt-1">
                  ...
                  <img src="assets/img/avatar/50.jpg" class="d-inline-block rounded-circle" width="80" alt="Avatar">
                  <div class="pt-2 mt-1">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/firefox-light.svg" class="d-block d-dark-mode-none mx-auto" width="165" alt="Firefox">
                <img src="assets/img/landing/saas-4/integrations/firefox-dark.svg" class="d-none d-dark-mode-block mx-auto" width="165" alt="Firefox">
                <div class="card-body text-center pt-1">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/pingdom-light.svg" class="d-block d-dark-mode-none mx-auto" width="165" alt="Pingdom">
                <img src="assets/img/landing/saas-4/integrations/pingdom-dark.svg" class="d-none d-dark-mode-block mx-auto" width="165" alt="Pingdom">
                <div class="card-body text-center pt-1">
                  ...
                  <img src="assets/img/avatar/52.jpg" class="d-inline-block rounded-circle" width="80" alt="Avatar">
                  <div class="pt-2 mt-1">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/woocommerce-light.svg" class="d-block d-dark-mode-none mx-auto" width="165" alt="WooCommerce">
                <img src="assets/img/landing/saas-4/integrations/woocommerce-dark.svg" class="d-none d-dark-mode-block mx-auto" width="165" alt="WooCommerce">
                <div class="card-body text-center pt-1">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/shopify-light.svg" class="d-block d-dark-mode-none mx-auto" width="165" alt="Shopify">
                <img src="assets/img/landing/saas-4/integrations/shopify-dark.svg" class="d-none d-dark-mode-block mx-auto" width="165" alt="Shopify">
                <div class="card-body text-center pt-1">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/laravel.svg" class="d-block mx-auto" width="165" alt="Laravel">
                <div class="card-body text-center pt-1">
                  <p class="pb-3 mb-3">Implementing AI models has never been easier or more reliable, thanks to this SaaS platform's seamless API integration and accurate, dependable results.</p>
                  <div class="pt-2 mt-1">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/vite-light.svg" class="d-block d-dark-mode-none mx-auto" width="165" alt="Vite">
                <img src="assets/img/landing/saas-4/integrations/vite-dark.svg" class="d-none d-dark-mode-block mx-auto" width="165" alt="Vite">
                <div class="card-body text-center pt-1">
                  <p class="pb-3 mb-3">Stay ahead of the curve and leverage cutting-edge technology with this SaaS platform's unparalleled performance and impressive results.</p>
                  <div class="pt-2 mt-1">
            ...
            <div class="masonry-grid-item col">
              <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                <img src="assets/img/landing/saas-4/integrations/angular-light.svg" class="d-block d-dark-mode-none mx-auto" width="165" alt="Angular">
                <img src="assets/img/landing/saas-4/integrations/angular-dark.svg" class="d-none d-dark-mode-block mx-auto" width="165" alt="Angular">
                <div class="card-body text-center pt-1">
                  <p class="pb-3 mb-3">Efficiently harness the power of AI models with this reliable and easy-to-use SaaS platform, featuring an API that provides excellent support and streamlines your processes.</p>
                  <div class="pt-2 mt-1">
      ...
      ">
        <div class="jarallax position-absolute top-0 start-0 w-100 h-100" data-jarallax data-speed="0.4">
          <div class="jarallax-img" style="background-image: url(assets/img/landing/saas-4/pricing-bg-pattern.png);"></div>
        </div>
          ...
          <div class="col-12 col-xl-3 pb-sm-2 pb-md-3 mb-4 mb-lg-5 mb-xl-0">
            ...
            <div class="d-flex flex-wrap flex-xl-column ps-xl-5 ms-n3 ms-xl-2">
              <ul class="nav flex-xl-column">
                ...
                <li class="nav-item mb-1">
                  <a href="#" class="nav-link py-1 px-xl-0">Careers<span class="badge bg-danger bg-opacity-10 rounded-pill ms-2"><span class="text-danger">Hiring</span></span></a>
                </li>
                <li class="nav-item mb-1">
