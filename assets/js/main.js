                ...
                for (let t = 0; t < e.length; t++) {
                    ...
                    if (n && "" !== n) {
                        const s = JSON.parse(n),
                            o = s.mapLayer || "https://api.maptiler.com/maps/pastel/{z}/{x}/{y}.png?key=0tMvERNYFNRqeBZUTyjD",
                    ...
                    } else i = L.map(e[t]).setView([0, 0], 1), L.tileLayer("https://api.maptiler.com/maps/pastel/{z}/{x}/{y}.png?key=0tMvERNYFNRqeBZUTyjD", {
                        tileSize: 512,
                        zoomOffset: -1,
                        minZoom: 1,
                        attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
